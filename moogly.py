...
class ApplicationMessage(discord.ui.View):
    ...
    @discord.ui.button(label='Seventh Haven', style=discord.ButtonStyle.blurple, custom_id='ApplicationMessage:seventh_haven_button', emoji=bot.config['seventh_haven_emoji_id'])
    ...
    @discord.ui.button(label='Moon', style=discord.ButtonStyle.green, custom_id='ApplicationMessage:moon_button', emoji=bot.config['moon_emoji_id'])
    ...
    @discord.ui.button(label='ONE', style=discord.ButtonStyle.red, custom_id='ApplicationMessage:one_button', emoji=bot.config['one_emoji_id'])
